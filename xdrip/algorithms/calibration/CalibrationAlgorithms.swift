...
func initialCalibration(firstCalibrationBgValue:Double, firstCalibrationTimeStamp:Date, secondCalibrationBgValue:Double, secondCalibrationTimeStamp:Date, sensor:Sensor, lastBgReadingsWithCalculatedValue0AndForSensor:inout Array<BgReading>, nsManagedObjectContext:NSManagedObjectContext, isTypeLimitter:Bool) -> (firstCalibration: Calibration, secondCalibration: Calibration){
    ...
    calculateWLS(for: calibration1, lastCalibrationsForActiveSensorInLastXDays: &tempCalibrationArray, firstCalibration: calibration1, lastCalibration: calibration1, isTypeLimitter: isTypeLimitter)
    ...
    calculateWLS(for: calibration2, lastCalibrationsForActiveSensorInLastXDays: &tempCalibrationArray, firstCalibration: calibration1, lastCalibration: calibration2, isTypeLimitter: isTypeLimitter)
...
func create(bgValue:Double, lastBgReading:BgReading, sensor:Sensor, lastCalibrationsForActiveSensorInLastXDays:inout Array<Calibration>, firstCalibration:Calibration, isTypeLimitter:Bool, nsManagedObjectContext:NSManagedObjectContext) -> Calibration {
    ...
    calculateWLS(for: calibration, lastCalibrationsForActiveSensorInLastXDays: &lastCalibrationsForActiveSensorInLastXDays, firstCalibration: firstCalibration, lastCalibration: lastCalibrationsForActiveSensorInLastXDays[0], isTypeLimitter: isTypeLimitter)
...
func rawValueOverride(for calibration:inout Calibration, rawValue:Double, lastCalibrationsForActiveSensorInLastXDays:inout Array<Calibration>, firstCalibration:Calibration, lastCalibration:Calibration, isTypeLimitter:Bool) {
    //TODO: - implement value override, there's no update of bgreading here ?
    calibration.estimateRawAtTimeOfCalibration = rawValue
    calculateWLS(for: calibration, lastCalibrationsForActiveSensorInLastXDays: &lastCalibrationsForActiveSensorInLastXDays, firstCalibration: firstCalibration, lastCalibration: lastCalibration, isTypeLimitter: isTypeLimitter)
}
...
///     - lastCalibration : result of call to Calibrations.lastCalibrationForActiveSensor
///     - isTypeLimitter : type limitter means sensor is Libre
private func calculateWLS(for calibration:Calibration, lastCalibrationsForActiveSensorInLastXDays:inout Array<Calibration>, firstCalibration:Calibration, lastCalibration:Calibration, isTypeLimitter:Bool) {
