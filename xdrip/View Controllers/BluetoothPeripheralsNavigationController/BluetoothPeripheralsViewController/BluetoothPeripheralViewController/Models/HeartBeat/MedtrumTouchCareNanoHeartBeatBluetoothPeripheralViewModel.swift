//
//  MedtrumTouchCareNanoHeartBeatBluetoothPeripheralViewModel.swift
//  xdrip
//
...
class MedtrumTouchCareNanoHeartBeatBluetoothPeripheralViewModel {
...
extension MedtrumTouchCareNanoHeartBeatBluetoothPeripheralViewModel: BluetoothPeripheralViewModel {
    ...
    func screenTitle() -> String {
        return BluetoothPeripheralType.MedtrumTouchCareNanoHeartBeatType.rawValue
    }

    func sectionTitle(forSection section: Int) -> String {

        // there's no section specific for this type of transmitter, this function will not be called
        return "Medtrum TouchCare Nano Heartbeat ♥"
