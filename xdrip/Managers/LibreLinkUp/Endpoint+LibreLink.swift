...
extension Endpoint {
    ...
    static func getEndpointForLatestLibreLinkEntries(hostAndScheme:String, count: Int, token: String?) -> Endpoint {
        ...
        guard scheme != nil else {
            ...
            fatalError("in getEndpointForLatestLibreLinkEntries, hostAndScheme doesn't start with a known scheme name")
        }
