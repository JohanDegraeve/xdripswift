...
class BGReadingSpeaker:NSObject {
    ...
    public func speakNewReading(lastConnectionStatusChangeTimeStamp: Date) {
        ...
        if UserDefaults.standard.speakDelta {
            ...
            var currentDelta:String = bgReadingToSpeak.unitizedDeltaString(previousBgReading: previousBgReading, showUnit: false, highGranularity: true, mgdl: UserDefaults.standard.bloodGlucoseUnitIsMgDl).string
