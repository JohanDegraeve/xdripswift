...
extension Double {
    ...
    func minutesToDaysAndHours() -> String {
        ...
        let hoursInMinutes = Int(self.truncatingRemainder(dividingBy: 24 * 60))
        let hours = Int(hoursInMinutes / 60)
        let minutes = Int(self.truncatingRemainder(dividingBy: 24 * 60 * 60))
