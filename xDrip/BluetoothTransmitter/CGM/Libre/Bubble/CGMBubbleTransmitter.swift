                    ...
                    case .dataPacket, .dataPacket2, .decryptedDataPacket:
                        ...
                        if rxBuffer.count >= 352 {
                            ...
                            if let libreSensorType = LibreSensorType.type(patchInfo: patchInfo) {
                                ...
                                if libreSensorType == .libre2 || libreSensorType == .libre2C5 || libreSensorType == .libre2C6 || libreSensorType == .libre27FPlus || libreSensorType == .libre27F || libreSensorType == .libreUS || libreSensorType == .libreUSE6 {
