...
public class PickerViewData {
    ...
    var largePresentationTitle: String?
    var subTitle: String?
    var data: [String]
    var selectedRow: Int
    ...
    ///     - largePresentationTitle : optional concise title used only by an oversized presentation
